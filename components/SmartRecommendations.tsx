    ...
    <section className="py-12 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link
            href="/shop"
            className="text-gold-600 hover:text-gold-700 font-medium flex items-center space-x-1 whitespace-nowrap"
          >
            <span>View All</span>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {products.map((product) => (
            ...
            >
              ...
              <div className="p-4">
                <h3 className="font-semibold text-gray-900 mb-2 line-clamp-2 group-hover:text-gold-600 transition-colors">
                  {product.name}
                </h3>
